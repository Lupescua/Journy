...
<html lang="en">
  ...
  <body>
  <nav class="navbar navbar-dark bg-light pos-f-t panel-transparent sticky-top">
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbaractor" aria-controls="navbaractor"
        aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon" href="<?php echo action('LocationController@index')?>">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="<?php echo action('HomepageController@index')?>">Home</a>
      </li>
    </ul>
  </button>
    </nav>
